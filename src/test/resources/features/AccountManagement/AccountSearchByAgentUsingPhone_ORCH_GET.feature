@AcmDetails_Regression @AcSearchByAgentUsingPhone
Feature: Testing Account Search by Agent using Phone Number - Orchestration Micro Services
  As a tester, I should be able to search for a customer by Phone number as a Dealer(US_DEALER,CA_DEALER) by using Account Search by Agent Micro service exposed from the Orchestration layer.
  Searches for a customer based on Phone number and returns minimum required customer information.

  @acm_smoke @AcmDetails_smoke @AcSearchByAgentUsingPhone-Smoke
  Scenario Outline: Agent Search for a Customer's Account by Phone number using Agent Search API exposed from Orchestration layer using valid input parameters (headers) and expect status code 200 OK <scenarioName>
  ...
  @AcSearchByAgentUsingPhone-Positive
  Scenario Outline: Agent Search for a Customer's Account by Phone number using Agent Search API exposed from Orchestration layer using valid input parameters (headers) and expect status code 200 OK <scenarioName>
    Given Tester calls the Create Customer Account POST api at "<basePath>"
    And Tester uses the headers with ContentType "<ContentType>" XBRAND "<XBRAND>" XCHANNEL "<XCHANNEL>" XCORRELATIONID "<XCORRELATIONID>" Authorization "<Authorization>"
    When Tester post the service with json body having customerType "<customerType>" firstName "<firstName>" lastName "<lastName>" email "<email>" phone "<phone>"
  ...
  @AcSearchByAgentUsingPhone-MissingHeaders
  Scenario Outline: Agent Search for a Customer's Account by Phone number using Agent Search API exposed from Orchestration layer with missing Headers and expect status code 400 <scenarioName>
    Given The Agent Search for a Customer Account GET api service "<basePath>" is up
...
#Removing both Key & Value pairs
      ...
      | Missing XBRAND Header key,Value pair             | /v1/account | application/json | MissingHeader | US_DEALER     | sendThroughCode | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 7703104059    | 400        | ORCH-0001    | Mandatory Header Attribute(s) Missing |

      | Missing T - XCHANNEL Header key,Value pair       | /v1/account | application/json | T             | MissingHeader | sendThroughCode | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 7703104059    | 400        | ORCH-0001    | Mandatory Header Attribute(s) Missing |
      | Missing T - XCORRELATIONID Header key,Value pair | /v1/account | application/json | T             | US_DEALER     | MissingHeader   | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 7703104059    | 400        | ORCH-0001    | Mandatory Header Attribute(s) Missing |
      | Missing T - Authorization Header key,Value pair  | /v1/account | application/json | T             | US_DEALER     | sendThroughCode | MissingHeader                            | 7703104059    | 401        | ORCH-0015    | Unauthorized.                         |
      | Missing T - Phone Number Header key,Value pair   | /v1/account | application/json | T             | US_DEALER     | sendThroughCode | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | MissingHeader | 400        | ORCH-0001    | Mandatory Header Attribute(s) Missing |

      | Missing L - XCHANNEL Header key,Value pair       | /v1/account | application/json | L             | MissingHeader | sendThroughCode | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 7703104059    | 400        | ORCH-0001    | Mandatory Header Attribute(s) Missing |
      | Missing L - XCORRELATIONID Header key,Value pair | /v1/account | application/json | L             | US_DEALER     | MissingHeader   | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 7703104059    | 400        | ORCH-0001    | Mandatory Header Attribute(s) Missing |
      | Missing L - Authorization Header key,Value pair  | /v1/account | application/json | L             | US_DEALER     | sendThroughCode | MissingHeader                            | 7703104059    | 401        | ORCH-0015    | Unauthorized.                         |
      | Missing L - Phone Number Header key,Value pair   | /v1/account | application/json | L             | US_DEALER     | sendThroughCode | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | MissingHeader | 400        | ORCH-0001    | Mandatory Header Attribute(s) Missing |

#Passing Empty values

      | Missing XBRAND Header Value                      | /v1/account | application/json |               | US_DEALER     | sendThroughCode | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 7703104059    | 400        | ORCH-0001    | Mandatory Header Attribute(s) Missing |

      | Missing T - XCHANNEL Header Value                | /v1/account | application/json | T             |               | sendThroughCode | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 7703104059    | 400        | ORCH-0001    | Mandatory Header Attribute(s) Missing |
      | Missing T - XCORRELATIONID Header Value          | /v1/account | application/json | T             | US_DEALER     |                 | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 7703104059    | 400        | ORCH-0001    | Mandatory Header Attribute(s) Missing |
      | Missing T - Authorization Header Value           | /v1/account | application/json | T             | US_DEALER     | sendThroughCode |                                          | 7703104059    | 401        | ORCH-0015    | Unauthorized.                         |
      | Missing T - Phone Number Header Value            | /v1/account | application/json | T             | US_DEALER     | sendThroughCode | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t |               | 400        | ORCH-0001    | Mandatory Header Attribute(s) Missing |

      | Missing L - XCHANNEL Header Value                | /v1/account | application/json | L             |               | sendThroughCode | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 7703104059    | 400        | ORCH-0001    | Mandatory Header Attribute(s) Missing |
      | Missing L - XCORRELATIONID Header Value          | /v1/account | application/json | L             | US_DEALER     |                 | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 7703104059    | 400        | ORCH-0001    | Mandatory Header Attribute(s) Missing |
      | Missing L - Authorization Header Value           | /v1/account | application/json | L             | US_DEALER     | sendThroughCode |                                          | 7703104059    | 401        | ORCH-0015    | Unauthorized.                         |
      | Missing L - Phone Number Header Value            | /v1/account | application/json | L             | US_DEALER     | sendThroughCode | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t |               | 400        | ORCH-0001    | Mandatory Header Attribute(s) Missing |

  @AcSearchByAgentUsingPhone-InvalidHeaders
  Scenario Outline: Agent Search for a Customer's Account by Phone number using Agent Search API exposed from Orchestration layer using invalid headers and expect status code 400 <scenarioName>
    Given The Agent Search for a Customer Account GET api service "<basePath>" is up
    When Tester uses the headers with ContentType "<ContentType>" XBRAND "<XBRAND>" XCHANNEL "<XCHANNEL>" XCORRELATIONID "<XCORRELATIONID>" Authorization "<Authorization>" phone "<phone>"
    And Tester calls the GET service
    Then the Customer account details should be searched in OCPR system by returning Status code "<statusCode>"
    ...
    Examples:
      ...
      | with L Invalid XCHANNEL-case sensitive             | /v1/account | application/json | L      | us_dealer | sendThroughCode                       | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 7703104059 | 400        | ORCH-0002    | Incorrect/Invalid Header Values |
      | with L Invalid XCHANNEL-Numbers                    | /v1/account | application/json | L      | 123       | sendThroughCode                       | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 7703104059 | 400        | ORCH-0002    | Incorrect/Invalid Header Values |
      | with L Invalid XCHANNEL-Symbols                    | /v1/account | application/json | L      | !@#       | sendThroughCode                       | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 7703104059 | 400        | ORCH-0002    | Incorrect/Invalid Header Values |
      | with L Invalid XCHANNEL-LA_SELF                    | /v1/account | application/json | L      | LA_SELF   | sendThroughCode                       | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 7703104059 | 400        | ORCH-0002    | Incorrect/Invalid Header Values |

      | with L Invalid XCORRELATIONID format 9-4-4-4-12    | /v1/account | application/json | L      | US_DEALER | 176558819-aace-43a2-a58e-2c3e1fd0eb93 | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 7703104059 | 400        | ORCH-0002    | Incorrect/Invalid Header Values |
      | with L Invalid XCORRELATIONID format 8-5-4-4-12    | /v1/account | application/json | L      | US_DEALER | 17655881-aace5-43a2-a58e-2c3e1fd0eb93 | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 7703104059 | 400        | ORCH-0002    | Incorrect/Invalid Header Values |
      | with L Invalid XCORRELATIONID format 8-4-5-4-12    | /v1/account | application/json | L      | US_DEALER | 17655881-aace-43a25-a58e-2c3e1fd0eb93 | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 7703104059 | 400        | ORCH-0002    | Incorrect/Invalid Header Values |
      | with L Invalid XCORRELATIONID format 8-4-4-5-12    | /v1/account | application/json | L      | US_DEALER | 17655881-aace-43a2-a58e5-2c3e1fd0eb93 | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 7703104059 | 400        | ORCH-0002    | Incorrect/Invalid Header Values |
      | with L Invalid XCORRELATIONID format 8-4-4-4-13    | /v1/account | application/json | L      | US_DEALER | 17655881-aace-43a2-a58e-2c3e1fd0eb93A | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 7703104059 | 400        | ORCH-0002    | Incorrect/Invalid Header Values |
      | with L Invalid XCORRELATIONID without hyphen       | /v1/account | application/json | L      | US_DEALER | 17655881AaaceA43a2Aa58eA2c3e1fd0eb93  | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 7703104059 | 400        | ORCH-0002    | Incorrect/Invalid Header Values |
      | with L Invalid XCORRELATIONID with 3 hyphens       | /v1/account | application/json | L      | US_DEALER | 123e4567-e89b-12d3-a456426655440000   | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 7703104059 | 400        | ORCH-0002    | Incorrect/Invalid Header Values |
      | with L Invalid XCORRELATIONID with 5 hyphens       | /v1/account | application/json | L      | US_DEALER | 123e4567-e89b-12d3-a456-4266-55440000 | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 7703104059 | 400        | ORCH-0002    | Incorrect/Invalid Header Values |
      | with L Invalid XCORRELATIONID with special symbols | /v1/account | application/json | L      | US_DEALER | 17655881-aace-43a2-a58e-2c3e1fd0e!@#  | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 7703104059 | 400        | ORCH-0002    | Incorrect/Invalid Header Values |
      | with L Invalid XCORRELATIONID length 35            | /v1/account | application/json | L      | US_DEALER | 17655881-aace-43a2-a58e-2c3e1fd0eb9   | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 7703104059 | 400        | ORCH-0002    | Incorrect/Invalid Header Values |


  @AcSearchByAgentUsingPhone-InvalidUser
  Scenario Outline: Agent Search for a Customer's Account by Phone number using Agent Search API exposed from Orchestration layer using invalid user phone and expect status code 404 <scenarioName>
    Given The Agent Search for a Customer Account GET api service "<basePath>" is up
    When Tester uses the headers with ContentType "<ContentType>" XBRAND "<XBRAND>" XCHANNEL "<XCHANNEL>" XCORRELATIONID "<XCORRELATIONID>" Authorization "<Authorization>" phone "<phone>"
    And Tester calls the GET service
    Then the Customer account details should be searched in OCPR system by returning Status code "<statusCode>"
    ...
    Examples:
      | scenarioName                          | basePath    | ContentType      | XBRAND | XCHANNEL  | XCORRELATIONID  | Authorization                            | phone       | statusCode | responseCode | description    |
      | with phone wihtout having account     | /v1/account | application/json | T      | US_DEALER | sendThroughCode | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 9000000000  | 404        | OCPR-0011    | User Not Found |

      | with T Invalid Phone number length 1  | /v1/account | application/json | T      | US_DEALER | sendThroughCode | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 7           | 404        | OCPR-0011    | User Not Found |
      | with T Invalid Phone number length 9  | /v1/account | application/json | T      | US_DEALER | sendThroughCode | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 903104059   | 404        | OCPR-0011    | User Not Found |
      | with T Invalid Phone number length 11 | /v1/account | application/json | T      | US_DEALER | sendThroughCode | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 77031040599 | 404        | OCPR-0011    | User Not Found |
#      | with T Invalid Phone with chars       | /v1/account | application/json | T      | US_DEALER | sendThroughCode | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | abcdefghig  | 404        | OCPR-0011    | User Not Found |
#      | with T Invalid Phone with symbols     | /v1/account | application/json | T      | US_DEALER | sendThroughCode | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | !@#$%^&*()  | 404        | OCPR-0011    | User Not Found |
      ...
      | with L Invalid Phone number length 11 | /v1/account | application/json | L      | US_DEALER | sendThroughCode | icZBMDlw2XOtuTLIZkfeFi1vTE8QXr4lr8tA6b7t | 77031040599 | 404        | OCPR-0011    | User Not Found |
...
#  @AcSearchByAgentUsingPhone-InternalServerError/SystemNotAvailable
#  Scenario Outline: Agent Search for a Customer's Account by Phone number using Agent Search API exposed from Orchestration layer using valid input when InternalServerError/SystemNotAvailable and expect status code 500 <scenarioName>
